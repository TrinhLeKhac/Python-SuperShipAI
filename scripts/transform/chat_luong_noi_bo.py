...
def status_chat_luong_noi_bo_ninja_van(series, col1='pct_success', col2='is_more_than_100'):
    if series[col1] == 0:
...
def transform_data_chat_luong_noi_bo():
    ...
    chat_luong_noi_bo_df['nvc'] = 'Ninja Van'
    chat_luong_noi_bo_df['tieu_chi'] = 'Chất lượng nội bộ'
    chat_luong_noi_bo_df['trong_so'] = TRONG_SO['Chất lượng nội bộ']['Tiêu chí']

    return chat_luong_noi_bo_df[['receiver_province', 'receiver_district', 'nvc', 'status', 'score', 'tieu_chi', 'trong_so']]
